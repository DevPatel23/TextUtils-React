        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li>
            <div className="d-flex">
              ...
              <div className="bg-dark rounded mx-2 my-2" onClick={() =>{props.togglemode('dark')}} style={{height: '30px', width: '30px', cursor: 'pointer'}} ></div>
              <div className="bg-light rounded mx-2 my-2" onClick={() =>{props.togglemode('light')}} style={{height: '30px', width: '30px', cursor: 'pointer'}} ></div>
            </div>
          </li>
          <li>
